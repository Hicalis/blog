...
const Article:FC = () => {
    ...
    return(
        <React.Fragment>
            <Header/>
            {status==="loading"?<div className={classes.article}>
                <Spin style={{margin:'auto auto'}}/>
                </div>:<div className={classes.article}>
